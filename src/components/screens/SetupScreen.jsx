...
export default function SetupScreen({ state, actions }) {
  ...
  return (
    <div className="min-h-dvh bg-apple-gray-50 dark:bg-black flex flex-col">
      <div className="flex-1 overflow-y-auto px-5 pt-14 pb-32 space-y-8">
        <div>
          <div className="flex justify-between items-center">
            <h1 className="text-[34px] font-semibold tracking-tight text-apple-label dark:text-white">
              {t(lang, "title")}
            </h1>
        ...
        <section className="space-y-3">
          ...
          {state.players.length > 0 ? (
            ...
            <p className="text-apple-gray-300 dark:text-apple-gray-600 text-[13px]">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-white dark:bg-apple-gray-900 border border-apple-gray-200 dark:border-apple-gray-700 rounded-2xl px-4 py-3 flex items-center justify-between">
            <span className="text-apple-label dark:text-white text-[17px]">
        ...
        <section className="space-y-3">
          ...
          <div className="bg-white dark:bg-apple-gray-900 border border-apple-gray-200 dark:border-apple-gray-700 rounded-2xl px-4 py-3 flex items-center justify-between">
            <div>
              <p className="text-apple-label dark:text-white text-[17px]">
                {t(lang, "imposterHints")}
              </p>
              <p className="text-apple-gray-400 dark:text-apple-gray-500 text-[13px] mt-0.5">
